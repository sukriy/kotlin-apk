...
import kotlinx.android.synthetic.main.activity_sukarela_add.*
...
class SukarelaAddActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sukarela_add)
        ...
        txt_tglPmbyrn.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus) {
                ...
                DatePickerDialog(this@SukarelaAddActivity,
                    dateSetListener,
        ...
        btn_add.setOnClickListener {
            ...
            if (nominal.isEmpty()) {
                ...
                if(seletedPhotoUri != null && gambar.getDrawable() != null){
                    println("opsi1")
                    val filePath = seletedPhotoUri?.let { it1 -> getRealPathFromURIPath(it1, this@SukarelaAddActivity) }
                ...
                RetrofitClient.instance.requestTabunganAdd(body, filter)
